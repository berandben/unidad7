...
public class LeerEscribirConBuffer {
...
File f = new File("flor.jpg");
           ...
           File archivosalida = new File("salida.jpg");
           
            FileOutputStream flujoSalida= new FileOutputStream(archivosalida);
            BufferedOutputStream fSalidaConBuffer = new BufferedOutputStream(flujoSalida);
            
            fSalidaConBuffer.write(bytearray);
            fSalidaConBuffer.close();
